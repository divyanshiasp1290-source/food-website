...
import { d as Button } from "./router-C14m0WRN.mjs";
import { N as Newspaper, B as BriefcaseBusiness, H as Handshake, A as ArrowRight, b as Mail, c as Building2, d as Phone, e as MapPin } from "../_libs/lucide-react.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 rounded-2xl bg-card border border-border p-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground", children: "+48 22 595 50 00" })
          ] })
        ] }),
