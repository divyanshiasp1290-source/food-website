  ...
  head: () => ({
    meta: [
      { title: "Contact — MARS POLSKA" },
      {
        name: "description",
        content:
          "Get in touch with MARS POLSKA — corporate registration details, partnerships, press, careers and customer enquiries.",
      },
      { property: "og:title", content: "Contact — MARS POLSKA" },
      { property: "og:description", content: "Reach MARS POLSKA." },
...
const OFFICES = [
  ...
  { city: "Lyon", country: "France", address: "12 Rue de la Confiserie, 69002 Lyon" },
          ...
          <Reveal>
            ...
            >
              ...
              <label className="flex gap-3 text-xs leading-relaxed text-muted-foreground">
                ...
                am 18 or older and consent to MARS POLSKA processing my information to respond to
                this enquiry.
              </label>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 rounded-2xl bg-card border border-border p-6">
                ...
                <div>
                  ...
                  <a
                    href="mailto:info@mars-polska.com"
                    className="text-muted-foreground hover:text-primary transition-colors font-medium"
                  >
                    info@mars-polska.com
                  </a>
                </div>
              </div>
              ...
              <div className="rounded-2xl bg-card border border-border p-6 space-y-4">
                <div className="flex items-start gap-4">
                  <span className="grid h-11 w-11 place-items-center bg-cocoa text-cream shrink-0">
                    <Building2 size={16} />
                  </span>
                  <div>
                    <div className="font-display text-lg font-bold">MARS POLSKA</div>
                    <div className="text-xs text-muted-foreground">Corporate Registration Details</div>
                  </div>
                </div>
                <div className="border-t border-border pt-4 space-y-2.5 text-xs sm:text-sm">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-0.5 py-1 border-b border-border/50">
                    <span className="text-muted-foreground">KRS Number (National Court Register):</span>
                    <span className="font-mono font-semibold text-foreground">0000313462</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-0.5 py-1 border-b border-border/50">
                    <span className="text-muted-foreground">NIP Number (Tax Identification Number):</span>
                    <span className="font-mono font-semibold text-foreground">7822441254</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-0.5 py-1 border-b border-border/50">
                    <span className="text-muted-foreground">VAT/EU ID:</span>
                    <span className="font-mono font-semibold text-foreground">PL7822441254</span>
                  </div>
              ...
              <div className="rounded-2xl overflow-hidden border border-border h-64 bg-secondary">
                <iframe
                  ...
                  src="https://www.openstreetmap.org/export/embed.html?bbox=20.25%2C52.18%2C20.35%2C52.26&amp;layer=mapnik"
                  className="size-full"
                  loading="lazy"
                />
              </div>
