  ...
  return (
    <footer className="bg-cocoa text-cream mt-24">
      <div className="container-x py-20 grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-xl">MARS POLSKA</span>
          </div>
      ...
      <div className="border-t border-cream/10">
        <div className="container-x py-6 flex flex-col md:flex-row gap-6 justify-between items-start md:items-center text-xs text-cream/75">
          <div className="space-y-1.5">
            <p className="font-bold text-cream text-sm">MARS POLSKA</p>
            <div className="flex flex-wrap gap-x-5 gap-y-1 text-cream/70">
              <span>KRS Number (National Court Register): <strong className="text-cream font-medium">0000313462</strong></span>
              <span>NIP Number (Tax Identification Number): <strong className="text-cream font-medium">7822441254</strong></span>
              <span>VAT/EU ID: <strong className="text-cream font-medium">PL7822441254</strong></span>
            </div>
          </div>
          <div>
            <span className="text-cream/60">Contact: </span>
            <a href="mailto:info@mars-polska.com" className="text-gold hover:underline font-medium">
      ...
      <div className="border-t border-cream/10">
        <div className="container-x py-6 flex flex-col md:flex-row gap-3 justify-between text-xs text-cream/60">
          <p>© {new Date().getFullYear()} MARS POLSKA. All rights reserved.</p>
